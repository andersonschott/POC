...
internal sealed class DocumentWriter<T> : IDisposable, IDocumentWriter<T> where T : IDocument
{
    ...
    public void Init()
    {
        ...
        // var connectionString = "DefaultEndpointsProtocol=https;AccountName=alocacao;AccountKey=LYBjoje2MuyHtzdU0sFL5oLyfnD/Gm4jnM57HpUkgG7TVblRLpERRyahrp/+j2TOBTlWysUp40qHwXot7cnbtA==;EndpointSuffix=core.windows.net";
        // var azureDirectory = new AzureDirectory(connectionString, "ativosl");
        // _writer = new IndexWriter(azureDirectory, indexConfig);
