...
internal sealed class DocumentReader<T> : IDocumentReader<T> where T : IDocument
{
    ...
    private void Init()
    {
        // var connection = "DefaultEndpointsProtocol=https;AccountName=alocacao;AccountKey=LYBjoje2MuyHtzdU0sFL5oLyfnD/Gm4jnM57HpUkgG7TVblRLpERRyahrp/+j2TOBTlWysUp40qHwXot7cnbtA==;EndpointSuffix=core.windows.net";
        // var azureDirectory = new AzureDirectory(connection, "ativosl");
